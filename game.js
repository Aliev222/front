...
function openSkinModal(skinId) {
    ...
    document.getElementById('skinModalDescription').textContent = skin.description || 'Нет описания';
    
    // Редкость
    const rarityEl = document.getElementById('skinModalRarity');
    rarityEl.textContent = getRarityName(skin.rarity);
    rarityEl.className = `skin-modal-rarity ${skin.rarity}`;
    
    // Бонус
    const bonusEl = document.getElementById('skinModalBonus');
    if (skin.bonus) {
        let bonusText = '';
        if (skin.bonus.type === 'multiplier') {
        ...
        document.getElementById('skinModalBonusValue').textContent = bonusText;
    ...
    // Требование
    const reqEl = document.getElementById('skinModalRequirement');
    const progressContainer = document.getElementById('skinModalProgress');
    const reqText = document.getElementById('skinModalReqText');
    const progressFill = document.getElementById('skinModalProgressFill');
    const progressText = document.getElementById('skinModalProgressText');
    ...
    // Статус
    const statusBadge = document.getElementById('skinStatusBadge');
    ...
    // Кнопка действия
    const actionBtn = document.getElementById('skinModalActionBtn');
    if (owned && !selected) {
        actionBtn.textContent = 'Выбрать';
        actionBtn.className = 'skin-modal-btn primary';
    } else if (!owned && canUnlockSkin(skin)) {
        actionBtn.textContent = 'Получить';
        actionBtn.className = 'skin-modal-btn primary';
    } else {
        actionBtn.textContent = 'Закрыть';
        actionBtn.className = 'skin-modal-btn secondary';
    }
...
function closeSkinModal() {
    document.getElementById('skinModalOverlay').classList.remove('active');
